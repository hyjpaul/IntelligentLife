    ...
    public MemoryCacheUtil() {
        ...
        mMemoryCache = new LruCache<String, Bitmap>((int) (maxMemory / 8)) {
            ...
            protected int sizeOf(String key, Bitmap value) {
                return value.getByteCount();//int byteCount = value.getRowBytes() * value.getHeight();// 计算图片大小:每行字节数*高度
            }
        };
    }

    //写缓存
    public void setMeoryCache(String url, Bitmap bitmap) {
//        强引用
